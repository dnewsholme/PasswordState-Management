...
if ($Passwordstate_management_dotsourcemodule) { $script:doDotSource = $true }
...
$importIndividualFiles = Get-PSFConfigValue -FullName Passwordstate-management.Import.IndividualFiles -Fallback $false
if ($Passwordstate_management_importIndividualFiles) { $importIndividualFiles = $true }
