...
### All (Default)
```
Invoke-PasswordStateReport [[-ReportID] <Int32>] [[-SiteID] <Int32>] [-ShowReportIDs] [-ShowAllReportIDs]
...
Invoke-PasswordStateReport [[-ReportID] <Int32>] [[-UserID] <String>] [[-SecurityGroupName] <String>]
 [[-DurationInMonth] <Int32>] [[-SiteID] <Int32>] [[-PasswordListIDs] <Nullable`1[]>] [-QueryExpiredPasswords]
 [-ShowReportIDs] [-ShowAllReportIDs] [-WhatIf] [-Confirm] [<CommonParameters>]
```
